...
/**
 * Describe:  lucene是一套用来开发搜索引擎的api，主要是创建索引和查询索引 这个类主要演示：创建索引、查询索引
 * Author:   maoxiangyi
 * Domain:   www.maoxiangyi.cn
 * Data:     2016/1/6.
 */
public class RAMDirectoryMain {

	public static void main(String[] args) throws Exception {
		Directory directory = new RAMDirectory();
		RAMDirectoryMain ramDirectoryMain = new RAMDirectoryMain();
		ramDirectoryMain.createIndex(directory);
		ramDirectoryMain.queryIndex(directory);
	}
	 ...
	 */
	@Test
	public void createIndex(Directory directory) throws Exception {
	 ...
	 */
	@Test
	public void queryIndex(Directory directory) throws Exception {
		// Directory是一个文件目录，里面有很多文件，文件在索引库创建的时被创建，可以对这些文件进行随机的读写。
		// FSDirectory 是一个基于文件系统的索引库，通过使用静态的open方法打开
